    ...
    function addTableBill()
    {
	  ...
	  // var tblEment=jQuery("#tblBill");
	   var rowHTML="<tr class='abc'><td><select class='goodId' id='goodId' name='goodId' style='width:120px'>"+
               "<option value=''>--------</option>"+
               "<c:forEach items='${goodList}' var='glist'>"+
			   ...
			   "<td><input type='button' value='删 除' onclick='delTableBill()' style='color:#F00; font-size:12px;'/></td>"+
			   "</tr>";
     ...
     <table class="form" cellpadding="0" cellspacing="0" border="0">
	     <tr>
		       ...
		       <td align="left">
			        <select id="storageId" name="storageId" style="width=100">
			           <option value="">--------</option>
			           <c:forEach items="${storage}" var="slist">
      ...
      <tr>
		<td colspan="2">
		  ...
		  <input type="button" value="提 交" class="ea-btn-green" onclick="saveOutStorage()" style="margin-left:5px;"/>
