...
<html>
  <head>
    ...
    <script type="text/javascript">
        $(function(){
           $("#mes").focus();
           $.post("cr_getManager.action?username="+$('#sender').val(),null,function(data){
               var datas = data.split("|");
               var lastElement=document.createElement("div");  
               lastElement.innerHTML = "<p>System&nbsp;&nbsp;&nbsp;&nbsp;" + datas[0] + "</p><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + datas[1];
    ...
    <div id="gb" style="width: 321px; height: 754px; border: solid 1px #000;">
        ...
        <div>
           <form id="mes_from" method="post" enctype="multipart/form-data">
              ...
              <textarea id="msgee" name="msgee" rows="" cols="" onkeydown="quick(event);"></textarea>
